...
latex_documents = [
  (master_doc, 'pytest-pytest-picked.tex', u'pytest-\\{\\{cookiecutter.plugin\\_name\\}\\} Documentation',
...
man_pages = [
    (master_doc, 'pytest-pytest-picked', u'picked Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pytest-pytest-picked', u'picked Documentation',
   author, 'pytest-pytest-picked', 'One line description of project.',
   'Miscellaneous'),
]
